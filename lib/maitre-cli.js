...
init
    ...
    .then(function(staticInput) {
        category = sourceops.guessRequestedCategory(staticInput.lists.categories, argv.k);
        ...
        return mongodb
            ...
            .then(function(siteT) {
                ...
                return siteinfo.detailSiteInfo(staticInput, siteT, howmany);
            })
            .tap(function(sinfo) {
                console.log(JSON.stringify(sinfo, undefined, 2));
