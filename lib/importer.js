...
var pickContent = function(headers, phantEstCT) {
    ...
    var retVal = (composedVal.indexOf(';') != -1) ?
        ...
        replacedCT = {
          ...
          "application/OpenDocumentImage": "vnd.oasis.opendocument.formula-template",
          "application/allegro": "application/vnd.allegro.public.v1+json",
          "application/fontobject": "application/vnd.ms-fontobject",
          "image/icon": "image/vnd.microsoft.icon",
          "application/opentype": "application/vnd.ms-opentype"
        };
...
var computeStats = function(inclusionMap) {
...
var importLog = function(fileEntry) {
...
var importPhantput = function(fileEntry) {
